...
const items = document.querySelectorAll(".container,.navbar,.sidebar,.toggle-ball")
...
class SnakeGame {
  ...
  draw() {
    ...
    this.trail.forEach(t => {
      this.context.fillRect(t.positionX * this.gridSize, t.positionY * this.gridSize, this.gridSize - 6, this.gridSize - 6);
    });

    // Son olarak elmayı ekrana çizdirelim:
    this.context.fillStyle = 'pink';
    this.context.fillRect(this.appleX * this.gridSize, this.appleY * this.gridSize, this.gridSize - 6, this.gridSize - 6);
  }
